    ...
    <>
      ...
      <section className="home-hero">
        ...
        <div className="hero-stats animate-4">
          <div className="hero-stat"><span className="hero-stat-number">40+</span><span className="hero-stat-label">Years Experience</span></div>
        ...
        <div className="cta-container" data-reveal>
          <div className="cta-text-side">
            ...
            <div className="cta-contact-details">
              ...
              <div className="cta-detail"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><span>21731 Ventura Boulevard #165, Woodland Hills, CA</span></div>
            </div>
          </div>
